...
<body>
    ...
    echo "<h1>BIO DATA</h1>";
    echo "<table width='60%'>";
    echo "<tr><td class='atas' width='30%'>Nama :</td><td width='30%'><input type='text' name='name' value='Nurhadiansyah'></td></tr>";
    echo "<tr><td class='atas'>NIM :</td><td><input type='text' name='name' value='2170231016'></td></tr>";
    echo "<tr><td class='atas'>Kelas :</td><td><input type='text' name='name' value='C1 P2K'></td></tr>";
    ...
    echo "<tr><td class='atas'>E-Mail :</td><td><input type='email' name='email' value='nurhadiansyah121@gmail.com'></td></tr>";
    echo "<tr><td class='atas'>Foto :</td><td><img src='iyan.jpg' width='200px'></img></td></tr>";
